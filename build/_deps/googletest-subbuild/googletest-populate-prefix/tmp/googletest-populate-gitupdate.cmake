...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" rev-parse "${ref}"
...
execute_process(
  COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" show-ref "main"
  WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
...
execute_process(
  COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" status --porcelain
  WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" rebase --abort
      WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src'."
    ...
    execute_process(
      COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" reset --hard --quiet
      WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
    )
    execute_process(
      COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" stash pop --quiet
      WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src"
      )
      execute_process(
        COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/home/sbronder/opensource/riccati/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
