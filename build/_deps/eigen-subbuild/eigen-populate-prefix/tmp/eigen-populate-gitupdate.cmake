...
execute_process(
  COMMAND "/mnt/sw/nix/store/bi6pi1qaz2ximhcwvqmg6qnnjixgxk38-git-2.39.1/bin/git" show-ref "3.4.0"
  WORKING_DIRECTORY "/mnt/home/sbronder/opensource/riccati/build/_deps/eigen-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/home/sbronder/opensource/riccati/build/_deps/eigen-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/home/sbronder/opensource/riccati/build/_deps/eigen-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
